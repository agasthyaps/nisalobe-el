Lesson 6: Write a Practice Argument Essay: Analyze and Draft an Introduction

<img src="media/image1.png" />

Food Choices

Grade 8: Module 2: Unit 3: Lesson 6

Lesson Overview

Lesson Summary

In this lesson, students closely analyze the introduction of the model essay, revise their plans, and draft the introduction of their practice essay.

CCS Standards

Focus Standards

These are the standards the instruction addresses.
...
2.  Engage the Learner (5 minutes)

3.  Work Time

4.  Analyze a Model: Introduction Paragraph – W.8.1a (10 minutes)

5.  Practice Essay: Draft an Introduction – W.8.1a (20 minutes)

6.  Closing and Assessment

7.  Peer Feedback: Practice Argument Essay Introduction – W.8.5 (10 minutes)

8.  Homework

9.  Review and Revise Practice Essay Introduction: Students revise their practice essay introduction based on feedback and criteria.

10. Independent Research Reading: Students read for at least 20 minutes in their independent research reading text. Then they select a prompt and write a response in their independent reading journal.
...
- An optional Mini Language Dive, intended for use after students analyze the introduction of the model essay in Work Time A, is available in the Lesson Plan section of this lesson. ▲
...
- Use the Grade 8 Writing Process checklist to assess students’ writing abilities in Work Times A and B (see the Tools page at http://eled.org/tools).
...
- 5-Minute Mini Language Dive Guide: “Transportation Choices”▲ (optional)

Student

- Entrance Ticket: Unit 3, Lesson 6 (one per student and one for display)

- 5-Minute Mini Language Dive Note-Catcher: “Transportation Choices”▲ (optional)
