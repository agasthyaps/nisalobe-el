English Language Learners: Grade 7: Module 4: Unit 3: Teaching Notes

Spread the Message: We Can Make a Difference!

Teaching Notes for Unit 3

Prioritize Lessons for Classrooms with Many English Language Learners

To prepare for the mid-unit assessment, prioritize and expand instruction in Lessons 1–5, which guide students to examine a model documentary script and then write and revise their own script. Students will engage in similar revision activities on the mid-unit assessment. ELLs, especially, may need support articulating their ideas in their script. The lessons and this guide incorporate modeling, peer-supported practice, and sentence frames to help ELLs express themselves.

To prepare for the end of unit assessment, prioritize instruction in Lessons 8–10, during which students analyze a model storyboard and create their own storyboard. Students also observe and practice a documentary pitch, refining their presentation skills. ELLs, especially, may need support presenting their script to their peers. The lessons and this guide incorporate modeling, peer-supported practice, and sentence frames to help ELLs express their ideas orally.

Language Dives

In Lessons 6–7, students participate in a Language Dive on a sentence from the Model Documentary Script. Students analyze how the author uses evidence to support the argument. Students also consider the placement and use of modifying phrases in the sentence.
...
Students work in pairs and triads to complete various tasks throughout the unit. Consider placing ELLs with partners who have similar language proficiency. The conversations and writing support that occur as a result of such strategic pairing will greatly serve the language development of both partners.
